  ...
  return (
    <div className='relative h-dvh w-screen overflow-x-hidden'>
      ...
      <div>
        ...
        <video ref={nextVdRef} src={getVideoSrc(currentIndex)} loop muted id='next-video' className='absolute-center invisible absolute z-20 size-64 object-cover object-center' onLoadedData={handleVideoLoad}></video>
